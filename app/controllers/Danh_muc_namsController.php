...
class Danh_muc_namsController extends BaseController {
	...
	public function index()
	{
		...
		return View::make('danh_muc_nams.index', compact('danh_muc_nams'));
	}
	...
	{
		return View::make('danh_muc_nams.create');
	}
	...
	public function show($id)
	{
		...
		return View::make('danh_muc_nams.show', compact('danh_muc_nam'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('danh_muc_nams.edit', compact('danh_muc_nam'));
	}
