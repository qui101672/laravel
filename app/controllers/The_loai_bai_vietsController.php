...
class The_loai_bai_vietsController extends BaseController {
	...
	public function index()
	{
		...
		return View::make('the_loai_bai_viets.index', compact('the_loai_bai_viets'));
	}
	...
	{
		return View::make('the_loai_bai_viets.create');
	}
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('the_loai_bai_viets.index');
		}

		return Redirect::route('the_loai_bai_viets.create')
			->withInput()
	...
	public function show($id)
	{
		...
		return View::make('the_loai_bai_viets.show', compact('the_loai_bai_viet'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('the_loai_bai_viets.edit', compact('the_loai_bai_viet'));
	}
	...
	public function update($id)
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('the_loai_bai_viets.show', $id);
		}

		return Redirect::route('the_loai_bai_viets.edit', $id)
			->withInput()
			->withErrors($validation)
			->with('message', 'There were validation errors.');
	}
