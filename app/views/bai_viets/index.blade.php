             ...
             <article class="post-container v2">
	            ...
	            <div class="span9">
	                <div class="post-content">
	                    <h4 class="title">{{ link_to_route('bai_viets.show', $bai_viet->tieu_de_bai_viet, array($bai_viet->id)) }}</a></h4>
	                    ...
	                    <div style="float:right;">{{ link_to_route('bai_viets.show', 'Chi Tiết ....	', array($bai_viet->id)) }}
	                    </div>
