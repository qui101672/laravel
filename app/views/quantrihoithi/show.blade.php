...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	<table class="table table-hover">
		<fieldset>
			<thead>
			<tr>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit_vongthi" id="modal-data">Thêm Vòng Thi</button>
		...
		@foreach ($vong_thi as $key => $value) 
			@foreach ($value as $value) 
				<tr>
                    ...
                    <td>{{ link_to_route('vong_this.edit', 'Sửa', array($value->id), array('class' => 'btn btn-default')) }}</td>
                    <td>
