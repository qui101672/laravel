    ...
    function diem(diem, id) {
        ...
        $.ajax({
            ...
            data: {id_tiet_muc: id,
                ...
                .done(function(data) {
                    if (data == 1) {
                        $('#input_diem_so_' + id).attr('readonly', 'true');
                        var n = noty({text: 'Nhập điểm thành công!!!', type: 'success'});
                    } else {
                        var n = noty({text: 'Nhập điểm không thành công!!!', type: 'error'});
                    }
                })
                .fail(function() {
                    console.log("error");
